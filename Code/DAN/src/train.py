...
def transfer_classification(config):
    # set pre-process
    prep_dict = {}
    # 两个item，item1=source；item2=target
    # 目标：把原来config设置的参数，利用pre_process函数处理，放到predict_dict中
...
if __name__ == "__main__":
    ...
    # 源域默认是amazon；目标域默认webcam；损失函数默认DAN
